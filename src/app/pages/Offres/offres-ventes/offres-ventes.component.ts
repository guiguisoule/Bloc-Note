...
@Component({
  selector: 'app-offres-ventes',
  templateUrl: './offres-ventes.component.html',
  styleUrls: ['./offres-ventes.component.css']
})
export class OffresVentesComponent implements AfterViewInit {
  ...
  chargerListOffre(){
    this.offreService.getOffreVenteList().subscribe(
      responce => {
